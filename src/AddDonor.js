...
function AddDonor() {
  ...
  if(donorDetails['email']===undefined||donorDetails['name']===undefined||donorDetails['phoneno']===undefined||donorDetails['password']===undefined||donorDetails['type']===undefined)
    ...
    const postData=(data)=>{
        axios.post(`${base_url}/savedonor`,data).then(
            (response)=>{
